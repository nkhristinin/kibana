...
export const useExecutionsWithDebugLog = ({ ruleId }: { ruleId: string }) => {
  const { addError } = useAppToasts();

  return useQuery<GetRuleExecutionResultsResponse>(
    ['detectionEngine', 'ruleMonitoring', 'executionResults', 'withDebugLOg', ruleId],
    ({ signal }) => {
      return api.fetchRuleExecutionsWithDebugLog({ ruleId, signal });
    },
    {
